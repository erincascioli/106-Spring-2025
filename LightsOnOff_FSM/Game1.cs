...
{
    // -----------------------------------------------
    // Enum to define the 2 states: on and off
    // -----------------------------------------------
    ...
    public class Game1 : Game
    {
        ...
        // -----------------------------------------------
        // Lights on variables - Rendering
        // -----------------------------------------------
        // Fields for rendering appropriate background
        ...
        protected override void Initialize()
        {
            ...
            // Instruction text init
            instructions = "Press F to turn light on.\nPress N to turn light off.";
